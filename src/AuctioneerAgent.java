...
public class AuctioneerAgent extends Agent {
    ...
    protected void setup() {
        ...
        if (args != null && args.length > 0) {
            ...
            averageTicketPrice = Double.parseDouble(args[3].toString());
                    ...
                    while (e.hasMoreElements()) {
                        ...
                        if(msg.getPerformative() == ACLMessage.PROPOSE){
                            ...
                            if(randomWinner){
                                ...
                                Proposal cfp = new Proposal(companyName, initLoc, finalLoc, averageTicketPrice,itemPrice,currentItemPrice, roundPriceIncrement,roundCounter,getAID());
                                try {
    ...
    private ACLMessage sendFirstCFP(){
        ...
        Proposal cfp = new Proposal(companyName, initLoc, finalLoc, averageTicketPrice,itemPrice,currentItemPrice, roundPriceIncrement,roundCounter,this.getAID());
